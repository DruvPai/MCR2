...
class TestClassInfo(unittest.TestCase):
    def test_y_to_pi(self):
        ...
        self.assertTrue(
            torch.allclose(naive_y_to_pi(y_informative, K_informative), pkg_y_to_pi(y_informative, K_informative)))
        self.assertTrue(torch.allclose(naive_y_to_pi(y_missingclasses, K_missingclasses),
                                       pkg_y_to_pi(y_missingclasses, K_missingclasses)))
